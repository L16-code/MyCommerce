...
import { CustomerRead, CustomerStatusUpdate, UserCreate, UserEdit, UserLogin, UserRead, UserStatusUpdate, UserUpdate } from "./controllers";
...
UserRouter.post('/customers-update-status', verifyToken,checkPermission(UPDATE_CUSTOMER_PERMISSIONS), HandleErrors(CustomerStatusUpdate))
